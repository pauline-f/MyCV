...
public class ExperienceFragment extends Fragment {
    public static final String FRAGMENT_TAG = "experience";
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Experience[] experience = parseWithGson(json);
        ...
        RecyclerView.Adapter adapter = new AdapterExperience(experience);
    ...
    protected Experience[] parseWithGson(String json) {
        Gson gson = new Gson();
        return gson.fromJson(json, CV.class).getExperience();
    }
