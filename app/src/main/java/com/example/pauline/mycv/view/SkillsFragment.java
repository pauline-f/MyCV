...
public class SkillsFragment extends Fragment {
    public static final String FRAGMENT_TAG = "skills";
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        String[] skills = parseWithGson(json);
        ...
        RecyclerView.Adapter adapter = new AdapterSkills(skills);
    ...
    protected String[] parseWithGson(String json) {
        Gson gson = new Gson();
        return gson.fromJson(json, CV.class).getSkills();
    }
}
