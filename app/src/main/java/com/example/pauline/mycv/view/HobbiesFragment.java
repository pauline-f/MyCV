...
public class HobbiesFragment extends Fragment {
    public static final String FRAGMENT_TAG = "hobbies";
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        String[] hobbies = parseWithGson(json);
        ...
        RecyclerView.Adapter adapter = new AdapterHobbies(hobbies);
    ...
    protected String[] parseWithGson(String json) {
        Gson gson = new Gson();
        return gson.fromJson(json, CV.class).getHobbies();
    }
