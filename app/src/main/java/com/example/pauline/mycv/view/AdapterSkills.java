...
public class AdapterSkills extends RecyclerView.Adapter<AdapterSkills.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            super(v);
            textViewSkill = v.findViewById(R.id.item_skill);
        }
    }

    // Provide a suitable constructor (depends on the kind of dataset)
    public AdapterSkills(String[] myDataset) {
        mDataset = myDataset;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public AdapterSkills.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                          int viewType) {
        // create a new view
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.textViewSkill.setText(mDataset[position]);
